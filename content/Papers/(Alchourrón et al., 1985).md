...
> [!question]+
> - [ ] Is $\div$ an operation over theories and propositions in the sense of being a function from $\mathcal{P}(\mathcal{L})\to \mathcal{L}$ (as I write in [[#^acd384]]), or is it defined specifically for a given theory $A$?
> - [ ] Is the issue of iterated belief revision, as it is formulated for AGM, related to the fact that any selection function is defined for a specific theory $A$?
