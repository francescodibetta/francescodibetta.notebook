...
3. We will discuss also the problem of revision iteration. In particular, we will see how [[(Darwiche & Pearl, 1997)]] make it possible to iterate revision by extending AGM's axioms, and by telling apart *epistemic states* (abstract objects that encode not only what an agent believes, but also their belief revision policies), and *belief sets* (sets of sentences which represent what a rational agent believes).
